...
<img width="100%" src="https://capsule-render.vercel.app/api?type=waving&color=0:08111F,45:0F172A,75:0EA5E9,100:7DD3FC&height=260&section=header&text=Riaz%20Ahmed%20Ansari&fontSize=48&fontColor=F8FAFC&fontAlignY=38&desc=Cybersecurity%20%7C%20Offensive%20%2B%20Defensive%20Security%20%7C%20ICS%2FOT%20%7C%20DevSecOps&descSize=17&descAlignY=61&animation=twinkling" alt="Riaz Ahmed Ansari"/>

<img width="100%" src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=600&size=26&duration=2700&pause=700&color=7DD3FC&center=true&vCenter=true&repeat=true&width=1200&height=75&lines=Red+Team+%2B+Blue+Team+%E2%80%94+Built+Around+Real+Security+Engineering;Active+Directory+Security+%7C+Detection+Engineering+%7C+Threat+Hunting;Splunk+%7C+Suricata+%7C+Zeek+%7C+Sysmon+%7C+MITRE+ATT%26CK;ICS%2FOT+Security+%7C+Purdue+Model+%7C+SCADA+%7C+Modbus+TCP;DevSecOps+%7C+Docker+%7C+Kubernetes+%7C+CI%2FCD+Security;Building+SIEMTRIX+%E2%80%94+ML-Driven+ICS+Threat+Detection+%26+Response" alt="Animated introduction"/>
...
## 🛡️ Security Engineer in the Making

I’m **Riaz Ahmed Ansari**, a cybersecurity graduate from Islamabad focused on the space where **offensive security, detection engineering, infrastructure security, and ICS/OT defense** meet.

My work is hands-on: I build attack labs, instrument telemetry, write detections, secure infrastructure, and test how systems behave under real operational pressure. I’ve worked across **Active Directory, SIEM, network security monitoring, DevSecOps, cloud, containers, and industrial environments**.

> **Current build:** **SIEMTRIX** — a Purdue Model-aligned ICS security platform combining command validation, centralized monitoring, network detection, ML-based anomaly detection, and automated response workflows.
...
Built a multi-zone industrial security architecture spanning **IT, DMZ, OT, and sensor layers**, with controls designed around segmented communication, command validation, RBAC, and centralized monitoring.

**What makes it interesting**
- Hybrid detection pipeline combining **Splunk, Suricata, Zeek, and ML-based anomaly detection**
- Detection logic mapped to **MITRE ATT&CK for ICS**
- Graduated response workflows supporting alerting, quarantine, and blocking
- Validated under **500 concurrent commands** with **100% delivery, zero message loss, and <148 ms average latency**
- Industrial stack includes **SCADA, Modbus TCP, ScadaBR, OpenModSim, and Purdue architecture**

`Splunk` `Suricata` `Zeek` `Python` `MITRE ATT&CK` `ICS/OT` `SCADA` `Modbus TCP`
...
- Continuous classification of malicious traffic
- Automated real-time security alerting
- ML experimentation using **XGBoost** and **Isolation Forest**
- Practical application of ML to network intrusion detection rather than offline-only analysis
...
- MITRE ATT&CK-mapped detection development
